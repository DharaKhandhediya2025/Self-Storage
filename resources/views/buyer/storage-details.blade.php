                    ...
                    <div class="banner-slider">
                        <div class="slider slider-for">
                            <div class="slider-banner-image">
                                <img src="{{ asset('public/Buyer-HTML/assets/img/detail-home.png') }}" alt="detail-home">
                            </div>
                        ...
                        <div class="slider slider-nav thumb-image">
                            <div class="thumbnail-image">
                                <div class="thumbImg">
                                    <img src="{{ asset('public/Buyer-HTML/assets/img/detail-nav-one.png') }}" alt="detail-nav-img" class="img-fluid">
                                </div>
                            </div>
                            <div class="thumbnail-image">
                                <div class="thumbImg">
                ...
                <div class="col-sm-12 col-md-12 col-lg-8 col-xl-8">
                    <div class="storage_details_left__main">
                        <div class="storage_name_box">
                            <div class="storage_name_box_left">
                                ...
                                <div class="store_contact_box">
                                    <a href="#"> <i class="fa fa-phone"></i> <span>+1 1234565789</span></a>
                                    <a href="#"> <i class="fa fa-phone"></i> <span>+1 1234565789</span></a>
                                </div>
                            </div>
                        ...
                        <div class="store_detail_box">
                            ...
                            <ul class="store_detail_ul">
                                <li class="store_detail_li">
                                    ...
                                    <span class="store_detail_span_right">800 sq.ft.</span>
                                </li>
                                <li class="store_detail_li">
                                    <span class="store_detail_span_left">Size</span>
                                    <span class="store_detail_span_right">800 sq.ft.</span>
                        ...
                        <div class="store_amenities_box">
                            <h4>Amenities</h4>
                            <a href="#"><img src="{{ asset('public/Buyer-HTML/assets/img/right_img.pn') }}" alt="right_img" class="img-fluid"><span
                                    class="store_amenities_span">Climate Control</span></a>
                            <a href="#"><img src="assets/img/right_img.png" alt="right_img" class="img-fluid"><span
                        ...
                        <div class="storage_review_box">
                                    ...
                                    <div class="storage_header_lftrft_box">
                                        <div>
                                            <a href="#"><img src="{{ asset('public/Buyer-HTML/assets/img/review-star.png') }}" alt="star"
                                                    class="img-fluid"></a>
                                            <a href="#"><img src="assets/img/review-star.png" alt="star"
                                                    class="img-fluid"></a>
                                            <a href="#"><img src="assets/img/review-star.png" alt="star"
                                                    class="img-fluid"></a>
                                            <a href="#"><img src="assets/img/review-star.png" alt="star"
                                                    class="img-fluid"></a>
                                            <a href="#"><img src="assets/img/review-star_empty.png" alt="star"
                                                    class="img-fluid"></a>
                                        </div>
                                        <h6>(3 Reviews)</h6>
                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="add_review_body_text text-center">
                                                            ...
                                                            <div class="review_modal_star">
                                                                <a href="#"><img src="{{ asset('public/Buyer-HTML/assets/img/review-star.png') }}"
                                                                        alt="review-star" class="img"></a>
                                                                <a href="#"><img src="assets/img/review-star.png"
                                                                        alt="review-star" class="img"></a>
                                                                <a href="#"><img src="assets/img/review-star.png"
                                                                        alt="review-star" class="img"></a>
                                                                <a href="#"><img src="assets/img/review-star.png"
                                                                        alt="review-star" class="img"></a>
                                                                <a href="#"><img src="assets/img/review-star_empty.png"
                                                                        alt="review-star" class="img"></a>
                                                            </div>
                            ...
                            <div class="review_card mb-3">
                                <div class="review_card_img">
                                    <img src="assets/img/review_img.png" alt="review-img" class="img-fluid">
                                </div>
                                <div class="review_card_content">
                                    ...
                                    <ul class="d-flex">
                                        ...
                                        <li><img src="assets/img/review-star.png" alt="star" class="img-fluid"></li>
                                        <li><img src="assets/img/review-star.png" alt="star" class="img-fluid"></li>
                                        <li><img src="assets/img/review-star.png" alt="star" class="img-fluid"></li>
                            ...
                            <div class="review_card mb-3">
                                <div class="review_card_img">
                                    <img src="{{ asset('public/Buyer-HTML/assets/img/review_img.png') }}" alt="review-img" class="img-fluid">
                                </div>
                                <div class="review_card_content">
                                    <h4>Ellen McLaughlin</h4>
                                    <h6>2 hours ago</h6>
                                    <ul class="d-flex">
                                        <li><img src="{{ asset('public/Buyer-HTML/assets/img/review-star.png') }}g" alt="star" class="img-fluid"></li>
                                        <li><img src="assets/img/review-star.png" alt="star" class="img-fluid"></li>
                                        <li><img src="assets/img/review-star.png" alt="star" class="img-fluid"></li>
                                        <li><img src="assets/img/review-star.png" alt="star" class="img-fluid"></li>
                                        <li><img src="{{ asset('public/Buyer-HTML/assets/img/review-star_empty.png') }}" alt="star" class="img-fluid">
                    ...
                    <div class="detail_inquiry_form">
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control detail_inquiry_input"
                                    placeholder="Ex. John adam">
                            </div>

                            <div class="form-group">
                                <label class="detail_inquiry_label">E-Mail</label>
                                <input type="email" class="form-control detail_inquiry_input"
                                    placeholder="Ex. loremipsum@mail.com">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control detail_inquiry_input" rows="3"
