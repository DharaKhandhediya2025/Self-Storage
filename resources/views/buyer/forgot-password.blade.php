@extends('buyer.headerfooter') @section('title','Forgot Password - Trouve ton entrepot')
        ...
        <div class="login_main_box">
            <div class="login_box">
                ...
                <div class="forgot_password_box text-center">
                    <img src="{{ config('global.front_base_url').'images/forgot-password-img.png' }}" alt="forgot-password-img" class="img-fluid">
