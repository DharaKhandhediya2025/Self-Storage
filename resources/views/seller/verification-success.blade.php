@extends('seller.headerfooter') @section('title','Verification Success - Trouve ton entrepot')
        ...
        <div class="login_main_box">
            <div class="login_box">
                ...
                <div class="forgot_password_box text-center mb-4 mt-5">
                    <img src="{{ config('global.front_base_seller_url').'images/password-reset-img.png' }}" alt="forgot-password-img" class="img-fluid">
                    <h4 class="pasword_succ_text">Verification Sucess</h4>
                    <p>Verification is success and now <br> you can proceed</p>
                </div>
                
                <a href="{{ url('/seller/location') }}">
