        ...
        <div class="container-fluid">
            ...
            <div class="my_account_tabing">
                ...
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link" id="myprofile-tab"  href="{{ url('seller/manage-profile') }}">My Profile</a>
                    ...
                    <a class="nav-link active" id="password-tab" href="{{ url('seller/change-password') }}" >Change password</a>
                ...
                @endif
                    ...
                    <form class="myaccount_form mt-4" action="{{ url('seller/change-password') }}" method="post">
                        @csrf
                        <div class="form-row">
