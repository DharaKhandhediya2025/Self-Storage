@extends('seller.headerfooter') @section('title','Reset Password - Trouve ton entrepot')
        ...
        <div class="login_main_box">
            <div class="login_box">
                ...
                <div class="forgot_password_box text-center mb-4">
                    <img src="{{ config('global.front_base_seller_url').'images/success-img.png' }}" alt="forgot-password-img" class="img-fluid">
                </div>
                ...
                <form class="login_form" action="{{ url('/seller/set-password') }}" method="POST">
