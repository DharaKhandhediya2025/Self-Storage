...
@section('content')
    <div class="row">
        <x-admin.form-header title="Features" subtitle="Features List"></x-admin.form-header>
        <div class="col s12">
            <div class="container">
                        ...
                        <div class="col s12 m12 l12">
                            <div id="button-trigger" class="card card card-default scrollspy">
                                <div class="card-content">
                                    ...
                                    <div class="col s12">
                                        <a href="{{ url('admin/add-features') }}" class="btn waves-effect waves-light invoice-export border-round right" title="Add New Feature">Add New Feature</a>
                                    </div>

                                    <h4 class="card-title">Feature List ({{ $count }})</h4>
                                                        ...
                                                        @foreach ($features as $row)
                                                            <tr>
                                                                ...
                                                                <td style="width:250px;text-align: center;">
                                                                    ...
                                                                    <a href="{{ route('admin.updatefeatures' ,['id'=> $row->id ])}}" title="Edit" class="btn-small btn-light-blue">Edit</a>
                                                                        ...
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    ...
                                                                                    <a href="{{ route('admin.deletefeatures' ,['id'=>$row->id ])}}" class="waves-effect waves-light btn gradient-45deg-red-pink box-shadow-none border-round mr-1 mb-1">Yes, Delete</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
