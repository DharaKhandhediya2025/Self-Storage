@extends('include.master')@section('title','Terms & Condition')

@section('content')
    <div class="row">
        <x-admin.form-header title="Terms & Condition" subtitle="Terms & Condition"></x-admin.form-header>
        <div class="col s12">
            <div class="container">
                <div class="section">
                    <!-- HTML VALIDATION  -->
                        ...
                        <div class="col s12">
                            ...
                            <div id="html-validations" class="card card-tabs">
                                <div class="card-content">
                                    ...
                                    <form class="formValidate0" id="formValidate0" method="post" enctype="multipart/form-data" action="{{ route('admin.termsadd') }}">@csrf
                                        <div class="row">
