@extends('include.master')@section('title','Buyers')

@section('content')
    <div class="row">
		<x-admin.form-header title="Buyer" subtitle="Buyer List"></x-admin.form-header>
		<div class="col s12">
		    <div class="container">
		                ...
		                <div class="col s12 m12 l12">
		                    <div id="button-trigger" class="card card card-default scrollspy">
		                        <div class="card-content">
		                            ...
		                            <h4 class="card-title">Buyer List ({{ $count }})</h4>
