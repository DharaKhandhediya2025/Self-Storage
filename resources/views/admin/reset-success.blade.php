                ...
                <div class="container">
                    <div id="login-page" class="row">
                        <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                            ...
                            <div class="row">
                                <h5 class="ml-4">Password Reset Successfully.</h5>
                            </div>

                            <div class="row">
                                <p style="margin-left: 20px;">Verification is success and now you can proceed</p>
                                <div class="input-field col s12">
                                    <a href="{{ url('/admin/login') }}">
                                        <button type="button" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12">Continue
                                        </button>
                                    </a>
                                </div>
                            </div>
